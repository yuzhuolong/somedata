...
mydir='C:\Users\jqrghs\Desktop\PMC实验\原始实验数据-肖老师-2016.04.18\走路右换左-没问题\';
walking_right2left=cell(1,250);
...
for i=1:length(filenames)
    ...
    walking_right2left{i}=temp(index_Max_accX-25:index_Max_accX+25,:);
