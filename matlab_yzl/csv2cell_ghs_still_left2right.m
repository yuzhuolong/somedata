...
mydir='C:\Users\jqrghs\Desktop\PMC实验\原始实验数据-肖老师-2016.04.18\左换右-没问题\';
still_left2right=cell(1,250);
...
for i=1:length(filenames)
    ...
    still_left2right{i}=temp(index_Max_accX-25:index_Max_accX+25,:);
