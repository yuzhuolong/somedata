...
rootdir = "E:\mypaper\data\iphone4_new\dtw_diff"
...
for root, dirs, files in list_dirs:
	...
	for f in files:
		...
		if ((count_acc > 0) and (count_acc == count_gyro)):
			...
			out_str = os.path.join(rootdir, 'dtw_diff_i4' + str(count_file) + '.csv')
			out_str_jiasudu = os.path.join(rootdir, 'dtw_diff_i4_jiasudu' + str(count_file) + '.csv')
