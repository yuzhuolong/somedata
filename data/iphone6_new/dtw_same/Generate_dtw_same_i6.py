...
rootdir = "E:\mypaper\data\iphone6_new\dtw_same"
...
for root, dirs, files in list_dirs:
	...
	for f in files:
		...
		if ((count_acc > 0) and (count_acc == count_gyro)):
			...
			out_str = os.path.join(rootdir, 'dtw_same_i6' + str(count_file) + '.csv')
			out_str_jiasudu = os.path.join(rootdir, 'dtw_same_i6_jiasudu' + str(count_file) + '.csv')
